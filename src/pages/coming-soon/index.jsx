...
//         <div className='text-2xl flex justify-center items-center min-h-screen w-full text-judtify'>
...
const MyComponent = () => {
  return (
    <div className="relative h-screen w-full flex items-center justify-center bg-cover bg-center text-center px-5" style={{backgroundImage: "url(https://images.pexels.com/photos/260689/pexels-photo-260689.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500)"}}>
      ...
      <div className="z-50 flex flex-col justify-center text-white w-full h-screen">
        ...
        {/* <div className="mt-6 flex text-white mx-auto">
          <a href="#">
            <svg fill="currentColor" className="cursor-pointer h-6 mr-2" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" xmlnsSerif="http://www.serif.com" style={{fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2}}>
